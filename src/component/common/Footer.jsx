...
// Heroicons ما فيها أيقونات شعارات (Facebook, Instagram...)، فاستخدمنا
// SVG بسيط مباشر لكل شعار بدل إضافة مكتبة جديدة فقط لهذا الغرض
const SOCIAL_LINKS = [
  {
    label: "Facebook",
    href: "#",
          ...
          <div className="mt-3 flex gap-3">
            {SOCIAL_LINKS.map((social) => (
              <a
                ...
                className="flex h-9 w-9 items-center justify-center rounded-full bg-white text-gray-500 shadow-sm transition hover:text-primary"
              >
